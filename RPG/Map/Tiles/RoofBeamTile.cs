...
namespace TeamStor.RPG
{
    ...
    {
        public RoofBeamTile(string id, MapLayer layer, string name, Point textureSlot, bool solid = false, int transitionPriority = 1000) : base(id, layer, name, textureSlot, solid, transitionPriority)
        {
        }
        ...
        {
            /* TODO bool faceLeft = mapPos.X - 1 > 0 &&
            ...
            game.Batch.Texture(
                ...
                0,
                null,
                /* TODO */ false ? SpriteEffects.FlipHorizontally : SpriteEffects.None);
        }
        ...
        public override void DrawAfterTransition(Engine.Game game, Point mapPos, Map map, SortedDictionary<string, string> metadata, Map.Environment environment, Color? color = null)
        {
            ...
            {
                if(map[Layer, mapPos.X, mapPos.Y + 1] != this)
                {
                    game.Batch.Texture(
