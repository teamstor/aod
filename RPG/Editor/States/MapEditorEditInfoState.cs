	...
	public class MapEditorEditInfoState : MapEditorModeState
	{
		...
		public override void OnEnter(GameState previousState)
		{
			BaseState.TextFields.Add("name", new TextField
			{
				...
				Position = new TweenedVector2(Game, new Vector2(Game.GraphicsDevice.Viewport.Width / 2 - 150, Game.GraphicsDevice.Viewport.Height / 2 - 90)),
			...
			BaseState.TextFields.Add("size", new TextField
			{
				...
				Position = new TweenedVector2(Game, new Vector2(Game.GraphicsDevice.Viewport.Width / 2 - 150, Game.GraphicsDevice.Viewport.Height / 2 - 90 + 36)),
				FocusChanged = (field, focus) =>
				{
            ...
            BaseState.ChoiceFields.Add("environment", new ChoiceField
            {
                ...
                Position = new TweenedVector2(Game, new Vector2(Game.GraphicsDevice.Viewport.Width / 2 - 150, Game.GraphicsDevice.Viewport.Height / 2 - 90 + 36 * 2)),
            ...
            BaseState.ChoiceFields.Add("weather", new ChoiceField
            {
                ...
                Position = new TweenedVector2(Game, new Vector2(Game.GraphicsDevice.Viewport.Width / 2 - 150, Game.GraphicsDevice.Viewport.Height / 2 - 90 + 36 * 3)),
                ChoiceChanged = (field, newIndex, newChoice) =>
                {
            ...
            BaseState.ChoiceFields.Add("combatarea", new ChoiceField
            {
                Game = Game,
                Label = "Is Combat Area",
                Choices = new string[] { "No", "Yes" },
                Choice = BaseState.Map.Info.CombatArea ? 1 : 0,
                Font = Game.DefaultFonts.Bold,
                Icon = Assets.Get<Texture2D>("editor/info/combatarea.png"),
                Position = new TweenedVector2(Game, new Vector2(Game.GraphicsDevice.Viewport.Width / 2 - 150, Game.GraphicsDevice.Viewport.Height / 2 - 90 + 36 * 4)),
                ChoiceChanged = (field, newIndex, newChoice) =>
                {
                    BaseState.Map.Info.CombatArea = newChoice == "Yes";
                },
                Width = 300
            });
        }
		...
		public override void OnLeave(GameState nextState)
		{
            ...
            BaseState.ChoiceFields.Remove("combatarea");
        }
