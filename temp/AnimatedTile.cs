...
namespace TeamStor.RPG
{
    ...
    public class AnimatedTile : Tile
    {
        ...
        public AnimatedTile(string id, MapLayer layer, string name, int textureCount, int fps, bool solid = false, int transitionPriority = 1000) : 
            base(id, layer, name, solid, transitionPriority)
        {
